...
const Hero = () => {
  const highlights = ["Atendimento humanizado e acolhedor", "Mais de 10 anos de experiência", "Ambiente seguro e confidencial"];
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-[#0c2461]">
      {/* Background Effects */}
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-6 animate-fade-in text-white" style={{
            animationDelay: "0.1s"
          }}>
              Encontre seu{" "}
            ...
            <p className="text-lg sm:text-xl text-white/80 max-w-xl mx-auto lg:mx-0 mb-8 animate-fade-in" style={{
            animationDelay: "0.2s"
          }}>
            ...
            {/* Highlights */}
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-8 animate-fade-in" style={{
            animationDelay: "0.3s"
          }}>
              {highlights.map((item, index) => <div key={index} className="flex items-center gap-2 text-sm text-white/70">
            ...
            animationDelay: "0.4s"
              ...
              <Button asChild size="lg" className="btn-premium text-primary-foreground font-semibold text-base px-8 h-14">
                <a href="https://wa.me/5500000000000?text=Olá! Gostaria de agendar uma consulta." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                  <Calendar className="w-5 h-5" />
                  Agendar Consulta
                </a>
              </Button>
              <Button asChild variant="outline" size="lg" className="font-semibold text-base px-8 h-14 border-white/30 text-white hover:bg-white/10 hover:text-white">
                <a href="https://wa.me/5500000000000?text=Olá! Gostaria de mais informações." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-muted-foreground text-primary-foreground">
