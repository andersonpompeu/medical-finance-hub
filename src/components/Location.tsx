      ...
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-2xl overflow-hidden border border-border/50 h-[400px] lg:h-full min-h-[400px]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.1975877813745!2d-46.65414!3d-23.5617!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjPCsDMzJzQyLjEiUyA0NsKwMzknMTQuOSJX!5e0!3m2!1spt-BR!2sbr!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
          ...
          <div className="space-y-6">
            ...
            <Button
              asChild
              size="lg"
              className="w-full btn-premium text-primary-foreground font-semibold h-14"
            >
              <a
                href="https://maps.google.com/?q=Rua+Exemplo+123+Centro+Sao+Paulo"
                target="_blank"
